...
import com.godsang.anytimedelivery.config.dataSource.ReplicationDataSourceProperties;
import com.godsang.anytimedelivery.config.dataSource.ReplicationRoutingSource;
...
public class ReplicationDatasourceConfig {
  ...
  /**
   * 직접 생성한 dataSource에 대한 정보를 등록한다.
   */
  @Bean
   ...
   * TransactionManager 식별 -> DataSource Connection 추출 -> Transaction 동기화(Connection 저장)
  ...
  public LocalContainerEntityManagerFactoryBean entityManagerFactory(@Qualifier("lazyRoutingDataSource") DataSource dataSource) {
    ...
    return entityManagerFactoryBuilder.dataSource(dataSource)
        .packages("com.godsang.anytimedelivery")
        .build();
  }
